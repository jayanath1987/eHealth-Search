...
echo "\n    <script type='text/javascript' src='".base_url()."js/bootstrap/js/bootstrap-datepicker.js' ></script>";
...
echo "\n    <link href='". base_url()."js/bootstrap/css/datepicker.css' rel='stylesheet' type='text/css' />";

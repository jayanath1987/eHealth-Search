	...
	<div class="container" style="width:95%;">
		...
		<?php echo Modules::run('leftmenu/lab'); //runs the available left menu for preferance ?>
			...
			<div class="panel panel-default"  >
                <div class="modal fade" id="labtests" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
				<div class="panel-heading"><b><?php echo $table_title; ?></b></div>
				<div id="patient_list">
				<?php echo $pager;  ?>
				</div>
			</div>

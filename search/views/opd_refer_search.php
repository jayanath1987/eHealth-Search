...
<div  style="width:95%;">
	<div class="row" style="margin-top:55px;">
	  <div class="col-md-2 ">
		<?php //echo Modules::run('leftmenu/clinic_patient'); //runs the available left menu for preferance ?>
	  </div>
	  <div class="col-md-10 ">
			<div class="panel panel-default"  >
				<div class="panel-heading"><b>Admission Referred patient list</b></div>
				<div id="patient_list">
				<?php echo $pager;  ?>
				</div>
			</div>
